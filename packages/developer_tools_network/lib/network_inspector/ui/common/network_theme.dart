...
/// All definitions for theming NetworkInspector.
class NetworkTheme {
  ...
  static ThemeData getTheme() {
    return ThemeData(
      useMaterial3: true,
      colorScheme: NetworkTheme._getColorScheme(),
  ...
  static ColorScheme _getColorScheme() =>
      _isDarkMode
          ? const ColorScheme.dark(primary: NetworkTheme.lightRed)
          : const ColorScheme.light(primary: NetworkTheme.lightRed);
