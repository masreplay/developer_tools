...
class NetworkTranslationData {
  /// Language code of locale, i.e (en_US) => en.
  final String languageCode;

  /// Translation values for language
  final Map<NetworkTranslationKey, String> values;

  NetworkTranslationData({required this.languageCode, required this.values});
}

/// Definition of all available translation keys.
enum NetworkTranslationKey {
  networkInspector,
  callDetails,
  emailSubject,
  callDetailsOverview,
