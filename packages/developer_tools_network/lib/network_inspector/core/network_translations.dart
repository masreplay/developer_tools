...
class NetworkTranslations {
  ...
  static final List<NetworkTranslationData> _translations = _initialise();

  /// Initialises translation data for all languages.
  static List<NetworkTranslationData> _initialise() {
  ...
  static NetworkTranslationData _buildEnTranslations() {
    return NetworkTranslationData(
      ...
      values: {
        ...
        NetworkTranslationKey.saveDialogPermissionErrorTitle: "Permission error",
        ...
        NetworkTranslationKey.saveHeaderTitle: "NetworkInspector - HTTP Inspector",
        ...
        NetworkTranslationKey.saveLogRequestContentType: "Request content type:",
        NetworkTranslationKey.saveLogRequestCookies: "Request cookies:",
        NetworkTranslationKey.saveLogRequestHeaders: "Request headers:",
        NetworkTranslationKey.saveLogRequestQueryParams: "Request query params:",
  ...
  static NetworkTranslationData _buildPlTranslations() {
    return NetworkTranslationData(
      ...
      values: {
        ...
        NetworkTranslationKey.callErrorScreenEmpty: "Brak danych do wyświetlenia",
        ...
        NetworkTranslationKey.callsListDeleteCallsDialogTitle: "Usuń połączenia",
        NetworkTranslationKey.callsListDeleteCallsDialogDescription:
        ...
        NetworkTranslationKey.statsRedirectionRequests: "Żądania przekierowania:",
        ...
        NetworkTranslationKey.statsUnsecuredRequests: "Żądania niezabezpieczone:",
        ...
        NetworkTranslationKey.saveHeaderTitle: "NetworkInspector - Inspektor HTTP",
